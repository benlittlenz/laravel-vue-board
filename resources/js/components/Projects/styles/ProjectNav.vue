<template>
  <header class="fixed z-50 h-16 w-full bg-gray-800 shadow flex items-center justify-between">
    <div class="flex items-center h-full ml-40">
      <div class="flex items-center w-64 ">
        <form
          action=""
          class="w-full h-full px-3 flex items-center"
        >
          <svg
          ...
          <input
            type="search"
            class="appearance-none bg-grey-darker h-full w-full py-2 px-2 text-gray-800 ml-4 rounded outline-none"
            placeholder="Search..."
          >
        </form>
      </div>
